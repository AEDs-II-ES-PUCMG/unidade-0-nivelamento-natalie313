...
public class Pedido {
     ...
     * @return String  
     */
	/*2.3. Inclusão Inteligente no Pedido -  "Produto já inserido."*/
    public String validacaoDeInsercao(Produto novo) {
		for (int i=0; i<=produtos.length; i++) {
			if(produtos.equals(novo)){
	...
	/**
     * Alterar a quantidade de item existente no pedido.
     * @param  quantidadeNova 
     * @return String  
     */
	/*2.3. Inclusão Inteligente no Pedido -  alterar a quantidade */
    public String alterarQuantidadeDeItens(Pedido pedido, int quantidadeNova) {
		for (int i=0; i<=produtos.length; i++) {
			pedido.quantProdutos = quantidadeNova;
		}
